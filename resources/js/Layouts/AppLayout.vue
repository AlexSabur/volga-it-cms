        ...
        <nav class="bg-white border-b border-gray-100">
                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        ...
                        <div class="flex items-center flex-shrink-0">
                            <inertia-link :href="route('offers')">
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            <jet-nav-link :href="route('offers')" :active="$page.currentRouteName == 'offers'">
                                Витрина 
                            </jet-nav-link>
                        </div>
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            <jet-nav-link :href="route('orders')" :active="$page.currentRouteName == 'orders'">
                                Заказы
                            </jet-nav-link>
                        </div>
                    </div>
            ...
            <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                <div class="pt-2 pb-3 space-y-1">
                    <jet-responsive-nav-link :href="route('offers')" :active="$page.currentRouteName == 'offers'">
                        offers
